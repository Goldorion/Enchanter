...
public class ModEnchantments {
    ...
    // Weapons
    public static final RegistryObject<Enchantment> MULTI_ARROWS = register("multi_arrows",
            new GenericEnchantment(new EnchantmentBuilder(Rarity.RARE, EnchantmentCategory.BOW, HANDS)
                    .setMaxLevel(4).setMinCost(20).setMaxCost(50).setCheckCompatibility(enchantment -> enchantment != Enchantments.INFINITY_ARROWS)));
    public static final RegistryObject<Enchantment> HYLIAN_SHIELD = register("hylian_shield",
            new GenericEnchantment(new EnchantmentBuilder(Rarity.VERY_RARE, EnchantmentCategory.BREAKABLE, HANDS)
    ...
    // Curses
    public static final RegistryObject<Enchantment> SLEEPLESS_NIGHT = register("sleepless_night",
            new GenericEnchantment(new EnchantmentBuilder(Rarity.VERY_RARE, EnchantmentCategory.ARMOR, ARMORS)
                    .setMinCost(25).setMaxCost(50).setTreasure().setCurse()));
    public static final RegistryObject<Enchantment> WRONG_BLOCK = register("wrong_block",
            new GenericEnchantment(new EnchantmentBuilder(Rarity.RARE, EnchantmentCategory.ARMOR, ARMORS)
                    .setMaxLevel(5).setTreasure().setTreasure().setCurse()));
    public static final RegistryObject<Enchantment> SLIPPERY_ROPE = register("slippery_rope",
            new GenericEnchantment(new EnchantmentBuilder(Rarity.RARE, EnchantmentCategory.BOW, HANDS)
                    .setMaxLevel(4).setMinCost(20).setMaxCost(50).setTreasure().setCurse()));
    public static final RegistryObject<Enchantment> SLIPPERY_HOOK = register("slippery_hook",
            new GenericEnchantment(new EnchantmentBuilder(Rarity.RARE, EnchantmentCategory.FISHING_ROD, HANDS)
                    .setMaxLevel(4).setMinCost(20).setMaxCost(50).setTreasure().setCurse()));


    //Misc
    public static final RegistryObject<Enchantment> MAGMA_WALKER = register("magma_walker",
            new MagmaWalker(Rarity.RARE, EquipmentSlot.FEET));


    // Treasures
    public static final RegistryObject<Enchantment> UNVANISHABLE = register("unvanishable",
            new GenericEnchantment(new EnchantmentBuilder(Enchantment.Rarity.VERY_RARE, EnchantmentCategory.VANISHABLE, ALL)
                    .setMaxLevel(3).setTreasure()));
    public static RegistryObject<Enchantment> SECOND_CHANCE = register("second_chance",
            new GenericEnchantment(new EnchantmentBuilder(Rarity.VERY_RARE, EnchantmentCategory.ARMOR_CHEST,
                    new EquipmentSlot[]{EquipmentSlot.CHEST}).setTreasure().setMinCost(25).setMaxCost(50)
                    .setCheckCompatibility(e -> !(e instanceof MendingEnchantment))));
    public static RegistryObject<Enchantment> ENDER_FRIEND = register("ender_friend",
            new GenericEnchantment(new EnchantmentBuilder(Rarity.RARE, EnchantmentCategory.ARMOR_HEAD, HEAD)
